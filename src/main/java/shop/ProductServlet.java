...
public class ProductServlet extends HttpServlet {
    ...
    public void init() throws ServletException{
        ...
        productList.add(new Product(1,"Iphone 13",599.25));
        productList.add(new Product(2,"Iphone SE",429.50));
        productList.add(new Product(3,"Iphone 14",799.25));
        productList.add(new Product(4,"Iphone 14 Pro",999.99));
